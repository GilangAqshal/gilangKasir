...
<?php 
	...
	$edit = $row->fetch();
?>
<form method="POST" action="petugasfungsi/edit/edit.php?kategori=edit">
    <table>
        <tr>
...
<?php }else{?>
    <form id="kategoriForm" method="POST" action="petugasfungsi/tambah/tambah.php?kategori=tambah">
    <table>
        <tr>
            <td style="width:25pc;">
            ...
            <td>
            <a href="index.php?page=kategori" class="btn btn-success btn-md mr-2"><i class="fa fa-refresh"></i> Refresh Data</a>
            </td>
        </tr>
    </table>
</form>
			...
			?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="petugasfungsi/hapus/hapus.php?kategori=hapus&id=<?php echo $isi['id_kategori'];?>"
