...
?>
 <a href="petugas.php?page=barang" class="btn btn-primary mb-3"><i class="fa fa-angle-left"></i> Balik </a>
 <h4>Edit Barang</h4>
...
<div class="card card-body">
	<div class="table-responsive">
		<table class="table table-striped">
			<form action="petugasfungsi/edit/edit.php?barang=edit" method="POST">
				<tr>
					<td>ID Barang</td>
