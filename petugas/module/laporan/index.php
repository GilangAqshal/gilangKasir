...
<div class="row">
	<div class="col-md-12">
		<h4>
			<!--<a  style="padding-left:2pc;" href="petugasfungsi/hapus/hapus.php?laporan=jual" onclick="javascript:return confirm('Data Laporan akan di Hapus ?');">
		...
		<div class="card">
			...
			<div class="card-body p-0">
				<form method="post" action="petugas.php?page=laporan&cari=ok">
					<table class="table table-striped">
						...
						<tr>
							...
							<td>
								...
								<a href="petugas.php?page=laporan" class="btn btn-success">
				...
				<form method="post" action="petugas.php?page=laporan&hari=cek">
					<table class="table table-striped">
						<tr>
							<th>
								Pilih Hari
